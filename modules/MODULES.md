...
|------|--------|-------------|
| `athena` | `finix.doas` | finix |
| `atlas` | `finix.doas` | finix |
| `bellerophon` | `desktop.services.graphics` | nixos |
| `bellerophon` | `desktop.apps.nh` | nixos |
| `hermes` | `finix.doas` | finix |
| `icarus` | `desktop.services.graphics` | nixos |
| `icarus` | `desktop.apps.nh` | nixos |
| `nimeses` | `desktop.services.graphics` | nixos |
| `nimeses` | `desktop.apps.nh` | nixos |
| `prometheus` | `finix.doas` | finix |
| `prometheus` | `finix.session` | finix |
