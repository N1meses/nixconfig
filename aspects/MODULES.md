...
| `desktop.apps.nh` | nixos+finix | nh, the nix helper CLI for rebuilds and garbage collection. | - |
...
| `desktop.services.graphics` | nixos+finix | GPU drivers and the X server fallback. | - |
...
| `dev.tools.git` | home | git with delta paging and the shared commit identity. | - |
...
| `finix.coreutils.busybox` | finix | Test Matrix: Selects busybox as the system coreutils provider. | - |
| `finix.coreutils.gnu` | finix | Test Matrix: Selects GNU coreutils as the system coreutils provider. | - |
| `finix.coreutils.uutils` | finix | Test Matrix: Selects Rust uutils as the system coreutils provider. | - |
| `finix.deviceManagers.gardendevd` | finix | Test Matrix: Selects gardendevd as the device manager. | - |
| `finix.deviceManagers.mdevd` | finix | Test Matrix: Selects mdevd as the device manager. | - |
| `finix.deviceManagers.udev` | finix | Test Matrix: Selects udev as the device manager. | - |
| `finix.doas` | finix | doas privilege escalation for the wheel group. | - |
| `finix.docker` | finix | Docker daemon with syslog wiring. | - |
| `finix.network.dhcpcd` | finix | Test Matrix: Selects dhcpcd as the network stack. | - |
| `finix.network.iwd` | finix | Test Matrix: Selects iwd as the network stack. | - |
